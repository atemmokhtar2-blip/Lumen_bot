...
:class:`~lumen.engine.engines.generators.project_planner.blueprint.ProjectBlueprint`
and the
:class:`~lumen.engine.engines.generators.blueprint_validator.validation_report.BlueprintValidationReport`.
