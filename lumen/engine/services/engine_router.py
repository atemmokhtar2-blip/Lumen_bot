...
def execute_ir(
    ...
    *,
    ...
    flat = {
        ...
        "start_command": (ir.metadata or {}).get("start_command"),
        "health_path": (ir.metadata or {}).get("health_path"),
        "port": (ir.metadata or {}).get("port"),
        "env_keys": (ir.metadata or {}).get("env_keys"),
