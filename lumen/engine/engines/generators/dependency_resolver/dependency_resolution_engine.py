...
1. ``project_blueprint`` — produced by the
   :class:`~lumen.engine.engines.generators.project_planner.ProjectPlanningEngine`.
2. ``blueprint_validation_report`` — produced by the
   :class:`~lumen.engine.engines.generators.blueprint_validator.BlueprintValidatorEngine`.
3. ``project_structure_map`` — produced by the
   :class:`~lumen.engine.engines.generators.structure_generator.StructureGenerationEngine`.
4. ``component_registry`` — produced by the
   :class:`~lumen.engine.engines.generators.component_detector.ComponentDetectionEngine`.
5. ``file_generation_plan`` — produced by the
   :class:`~lumen.engine.engines.generators.file_planner.FileGenerationPlanningEngine`.
