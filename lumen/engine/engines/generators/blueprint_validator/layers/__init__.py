...
:class:`~lumen.engine.engines.generators.blueprint_validator.blueprint_validator_engine.BlueprintValidatorEngine`
runs against a :class:`ProjectBlueprint`.

Each layer is a small, focused, stateless validator that returns a
:class:`~lumen.engine.engines.generators.blueprint_validator.validation_report.LayerResult`.
