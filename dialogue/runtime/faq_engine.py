    ...
    def _load(self) -> list[tuple[str, str]]:
        ...
        seeds = {
            ...
            "ask_plan_details": [
                ...
                "اشرح لي تفاصيل الباقة الحالية",
                "اشرحلي تفاصيل الباقة الحالية",
                "اشرح لي تفاصيل الخطة الحالية",
                "اشرحلي تفاصيل الخطة الحالية",
                "ايه تفاصيل الباقة الحالية",
                "ما هي تفاصيل الباقة الحالية",
            ],
            "ask_plan_limits": [
                "فاضل لي كم عملية توليد",
                "فاضل لي كام عملية توليد",
                "كم عملية توليد متبقية",
                "المتبقي من التوليد",
            ],
