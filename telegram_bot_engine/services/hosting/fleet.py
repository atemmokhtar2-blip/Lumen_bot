...
class FleetRegistry:
    ...
    def _connect(self):
        from telegram_bot_engine.services.hosting.pg_control_plane import connect
        return connect()
    ...
    def register(
        ...
        *,
        ...
        from telegram_bot_engine.services.hosting.capacity import local_node_capacity
