    ...
    if phase == EngineUiPhase.GEN_TYPE:
        return html_card(
            ...
            [
                (
                    "✍️ اكتب الوصف",
                    "اكتب وصف المشروع في رسالة واحدة.\n"
                    "النوع يُكتشف تلقائياً: بوت تيليجرام، موقع، أو API.\n"
                    "مثال: موقع معرض أعمال بـ FastAPI — أو بوت متجر للطلبات.",
                ),
            ],
            subtitle="رسالة واحدة واضحة تكفي — بدون اختيار نوع يدوياً",
        )
