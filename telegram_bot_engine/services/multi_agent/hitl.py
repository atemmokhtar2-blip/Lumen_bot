...
def tool_risk(tool: str) -> str:
    try:
        from telegram_bot_engine.services.tool_runtime.registry import tool_risk_level
...
def request_confirmation(
    ...
    *,
    ...
    try:
        from telegram_bot_engine.services.tool_runtime.registry import redact_secrets
    except Exception:
