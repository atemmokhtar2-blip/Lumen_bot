...
CAN_DO_AR = [
    ...
    "✨ بناء فوري: وصف بسيط = بوت جاهز للتشغيل (SQLite، سلة، نقاط، اشتراكات).",
    "🚀 استضافة: بوتك يعمل في بيئة معزولة وآمنة.",
...
def get_help_text() -> str:
    ...
    return html_card(
        ...
        [
            ...
            ("⚠️ ⚠️ ما ليس ضمن اختصاصي حالياً", html_bullets(CANNOT_DO_AR)),
        ],
