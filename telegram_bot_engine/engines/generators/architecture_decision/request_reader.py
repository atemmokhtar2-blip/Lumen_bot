...
class RequestData:
    ...
    Attributes:
        ...
        cleaned_request: The request after cleaning.
        project_name: The suggested project name.
        ...
        bot_types: The list of bot type identifiers.
...
class RequestReader:
    ...
    present, it extracts the structured fields.  When the analysis
    report is not present, it falls back to the raw
    ``context.request``.
    """
