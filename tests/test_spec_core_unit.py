...
def test_builder_import_and_surface():
    from lumen.engine.spec_core import builder
...
def test_acceptance_gate_importable():
    from lumen.engine.spec_core import acceptance_gate

    assert acceptance_gate is not None


def test_capability_integrity_module():
    from lumen.engine.spec_core import capability_integrity
...
def test_prod_hard_locks_force_off_in_production(monkeypatch):
    from lumen.engine.services import prod_hard_locks as ph
