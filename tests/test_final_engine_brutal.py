...
from telegram_bot_engine.spec_core.presets import detect_preset, detect_preset_stack, score_presets
from telegram_bot_engine.spec_core.arabic_intent_engine import (
    classify_intent,
    extract_bot_name,
    is_clearly_non_bot,
)
...
from bot_interface.sanitize import sanitize_error, assert_safe_fs_path
