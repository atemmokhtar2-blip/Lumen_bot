...
def render_onboarding(facts: UiFacts) -> str:
    """First-time onboarding — rich explanation, examples, invitation.

    Shown only once per user (the caller tracks ``lumen_welcome_shown``).
    Returning users see the compact ``_render_home`` instead.
    """
    bal = int(facts.credits_available or facts.credits_balance or 0)
    lines = [
        "👋 أهلاً بك في Lumen!",
        "",
        "Lumen منصّة ذكاء اصطناعي تصنع لك بوتات تيليجرام كاملة —",
        "من فكرة في رأسك إلى بوت يعمل فعلاً، بدون كتابة سطر برمجة واحد.",
        "",
        "🔬 كيف يعمل؟",
        "1️⃣ اكتب وصفاً عادياً لما تريد أن يفعله البوت",
        "2️⃣ يقوم المحرك ببرمجته وبناءه بالكامل",
        "3️⃣ تحصل على بوت جاهز للنشر والاستخدام",
        "",
        "💡 أمثلة على ما يمكنك صنعه:",
        "• 🛒 بوت متجر — يعرض منتجاتك، يستقبل الطلبات، ويرسل التفاصيل",
        "• ⏰ بوت تذكيرات — يرسل لك تنبيهات يومية بالمهام والمواعيد",
        "• ❓ بوت أسئلة شائعة — يجيب على عملائك تلقائياً بدل الميكروبي",
        "• ✅ بوت إدارة مهام — قائمة مهام مع تنبيهات عند الاقتراب من الموعد",
        "• 📊 بوت تقارير — يرسل لك إحصائيات دورية عن نشاطك",
        "• 🎓 بوت تعليمي — يشرح دروساً ويختبر فهمك بأسئلة",
        "",
        "✨ ما الذي يميّز Lumen؟",
        "• وصف بسيط بالعربية يكفي — لا حاجة لخبرة تقنية",
        "• البوت يُبنى بالكامل: الكود، الواجهة، والأوامر",
        "• تشغيل ومعاينة فورية قبل النشر",
        "",
        f"🎁 ابدأ الآن — لديك {bal} كريديت جاهز للاستخدام",
        "",
        "اضغط زر «🔧 صنع بوت جديد» بالأسفل لتجربته الآن 👇",
    ]
    return "\n".join(lines)
