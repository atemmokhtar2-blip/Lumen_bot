"""
Context reader — reads the project context from the generation
context.
...
class ContextData:
    ...
    Requirement Normalization Engine needs from the Project Context.
...
class ContextReader:
    ...
    present, it extracts the goal, features, components, files, and
    dependencies.  When absent, it returns a :class:`ContextData`
