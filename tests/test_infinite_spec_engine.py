...
def test_plan_model_in_schema_py():
    from lumen.engine.spec_core.schema import (
        DynamicBotSpec,
        FlowNode,
        run_rule_engine,
...
def test_validate_ok():
    from lumen.engine.spec_core.dynamic_bot_spec import parse_dynamic_spec
...
def test_rule_engine_send_message():
    from lumen.engine.spec_core.rule_engine import run_rule_engine
...
def test_compose_and_route():
    from lumen.engine.spec_core.infinite.compose import compose_infinite_from_payload
    from lumen.engine.spec_core.infinite.engine_router import route_and_execute
...
def test_macro_promote(tmp_path, monkeypatch):
    ...
    from lumen.engine.spec_core.infinite.macro_registry import MacroRegistry
