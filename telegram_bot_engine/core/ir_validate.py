...
from telegram_bot_engine.core.ir import AcceptanceCriterion, BuildIR, EngineMode, IRStatus
...
def validate_and_normalize_ir(ir: BuildIR) -> IRValidation:
    ...
    try:
        from telegram_bot_engine.spec_core.domain_detector import decide
        from telegram_bot_engine.spec_core.lean_packs import pack_for_domain
...
def check_project_against_ir(project_path: str, ir: BuildIR) -> dict[str, Any]:
    ...
    core = {"start", "help", "lang", "language", "cancel"}
    try:
        from telegram_bot_engine.spec_core.command_map import primary_commands
