...
_add(
    ...
    _c("user_unwarn", "moderation", "unwarn_user", "إزالة تحذير", "Unwarn", "admin", ("ban_users",), True, "moderation"),
    _c("clear_warnings", "moderation", "clear_warnings", "مسح كل التحذيرات", "Clear warnings", "admin", ("ban_users",), True, "moderation"),
    _c("list_warnings", "moderation", "get_warns", "عرض تحذيرات عضو", "List warnings", "admin", (), True, "moderation"),
    _c("admin_log", "moderation", "list_log", "سجل الإجراءات الإدارية", "Admin audit log", "admin", (), False, "moderation"),
    _c("set_forbidden", "moderation", "add_forbidden", "إضافة كلمة ممنوعة", "Add forbidden word", "admin", (), False, "moderation"),
    _c("del_forbidden", "moderation", "remove_forbidden", "حذف كلمة ممنوعة", "Remove forbidden word", "admin", (), False, "moderation"),
    _c("list_forbidden", "moderation", "list_forbidden", "قائمة الكلمات الممنوعة", "List forbidden words", "admin", (), False, "moderation"),
    _c("set_protection", "moderation", "set_protection", "ضبط الحماية", "Configure protection", "admin", (), False, "moderation"),
    _c("set_max_warns", "moderation", "set_max_warns", "حد التحذيرات", "Set max warns", "admin", (), False, "moderation"),
    _c("set_owner", "moderation", "set_owner", "تعيين Owner للجروب", "Set group owner", "owner", (), True, "moderation"),
    _c("set_role", "moderation", "set_role", "تعيين رتبة", "Set rank", "owner", (), True, "moderation"),
    _c("pubg_register", "pubg", "register_player", "تسجيل لاعب PUBG", "Register PUBG player", cat="pubg"),
    _c("pubg_players", "pubg", "list_players", "قائمة اللاعبين", "List players", cat="pubg"),
    _c("pubg_team", "pubg", "set_team", "تعيين فريق", "Set team", cat="pubg"),
    _c("pubg_teams", "pubg", "list_teams", "عرض الفرق", "List teams", cat="pubg"),
    _c("pubg_match", "pubg", "record_match", "تسجيل نتيجة مباراة", "Record match", "admin", cat="pubg"),
    _c("pubg_top", "pubg", "top_players", "أفضل اللاعبين", "Top players", cat="pubg"),
    _c("pubg_stats", "pubg", "player_stats", "إحصائيات لاعب", "Player stats", cat="pubg"),
    _c("pubg_tournament", "pubg", "create_tournament", "إنشاء بطولة", "Create tournament", "admin", cat="pubg"),
)
