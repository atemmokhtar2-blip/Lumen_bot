...
def emit(
    ...
    *,
    ...
    try:
        ...
        # Phase E — metrics + operational alerts
        try:
            from lumen.platform.security_metrics import record_security_event
            record_security_event(event_type, severity)
        except Exception:
            logger.debug("security_metrics_skipped", exc_info=True)
        try:
