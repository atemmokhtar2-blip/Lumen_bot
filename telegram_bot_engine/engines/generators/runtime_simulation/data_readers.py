"""Tolerant data readers for Runtime Simulation (Spec 040)."""
...
class StaticAnalysisReader(_BaseReader):
    ARTEFACT_KEY = "static_analysis_report"
    LIST_KEY = "issues"


class ArchitectureComplianceReader(_BaseReader):
...
class CodeRefactoringReader(_BaseReader):
...
__all__ = [
    ...
    "ArchitectureComplianceReader",
    "PerformanceReader",
    "SecurityReader",
    "CodeRefactoringReader",
