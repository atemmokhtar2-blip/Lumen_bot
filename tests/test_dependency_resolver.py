...
from lumen.engine.core import build_configuration, bootstrap
from lumen.engine.core.context import GenerationContext
from lumen.engine.engines.generators.project_planner import (
    BlueprintValidation,
...
from lumen.engine.engines.generators.blueprint_validator import (
    BlueprintValidationReport,
    QualityScore,
    STATUS_APPROVED,
    STATUS_REJECTED,
)
from lumen.engine.engines.generators.structure_generator import (
    BuildOrderEntry,
...
from lumen.engine.engines.generators.component_detector import (
    ComponentRegistry,
    DetectedComponent,
...
from lumen.engine.engines.generators.file_planner import (
...
from lumen.engine.engines.generators.dependency_resolver import (
...
def test_graph_builder_inter_dependency():
    ...
    from lumen.engine.engines.generators.dependency_resolver.dependency_graph_builder import _KNOWN_INTER_DEPENDENCIES
