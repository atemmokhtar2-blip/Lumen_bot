...
def capability_system_health() -> dict[str, Any]:
    ...
    modules = [
        "lumen.engine.services.capability_detection.engine",
        "lumen.engine.services.capability_detection.synthesis",
        "lumen.engine.services.capability_detection.web_research",
        "lumen.engine.services.capability_detection.learning_loop",
        "lumen.engine.services.capability_detection.pack_promotion",
        "lumen.engine.services.capability_detection.pipeline_trace",
        "lumen.engine.services.capability_detection.packs.loader",
        "lumen.engine.services.capability_detection.packs.emit_contract",
    ]
    for mod in modules:
        try:
            __import__(mod)
