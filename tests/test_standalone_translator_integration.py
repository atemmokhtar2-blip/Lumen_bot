...
def main() -> None:
    os.environ.pop("LUMEN_TRANSLATOR_ENABLED", None)
    ...
    if os.environ.get("RUN_TRANSLATOR_SERVICE_TESTS") == "1":
        ...
        os.environ["LUMEN_TRANSLATOR_URL"] = os.environ.get(
            "LUMEN_TRANSLATOR_URL", "http://127.0.0.1:18082"
        )
        os.environ["LUMEN_TRANSLATOR_TIMEOUT_SEC"] = "10"
    ...
    os.environ["LUMEN_TRANSLATOR_ENABLED"] = "0"
