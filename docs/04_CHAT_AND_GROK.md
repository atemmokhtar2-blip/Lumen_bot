...
```python
from telegram_bot_engine.services.llm.facade import chat_request, translate_request
# أو عبر
from telegram_bot_engine.services.translator_client import chat_request, translate_request
```
...
`telegram_bot_engine/services/chat_router/service.py` يسجّل قدرات (`Capability`) بعبارات عربية/إنجليزية:
