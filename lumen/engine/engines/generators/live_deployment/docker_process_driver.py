...
def _seccomp_arg() -> str:
    ...
    if p and os.path.isfile(p):
        return p
    try:
        from lumen.engine.services.sandbox_runtime.network import seccomp_profile_path
...
class DockerProcessDriver(DeploymentProvider):
    ...
    def deploy(
        ...
        *,
        ...
        try:
            from lumen.engine.services.isolation_policy import is_multi_tenant
        ...
        from lumen.engine.services.bot_image_builder import build_image
        ...
        try:
            from lumen.engine.services.bot_image_builder import validate_image_tag
        ...
        try:
            ...
            try:
                from lumen.engine.services.prod_hard_locks import token_in_env_file_allowed
            ...
            try:
                from lumen.engine.services.sandbox_runtime.policy import (
